...
\begin{enumerate}
    ...
    \item \textbf{H$_0$ Jitter Correlation:} As Vera C monitors $H_0$ fluctuations, localized warping at the IST-1 will correlate with the 6\% biennial volumetric loss identified in the RIM 22-year session[cite: 18].
\end{enumerate}
